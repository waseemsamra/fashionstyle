              ...
              <div key={product.id} className="min-w-[50%] lg:min-w-[25%] px-3">
                <div className="group bg-white rounded-2xl overflow-hidden shadow-card hover:shadow-hover transition-all duration-500 hover:-translate-y-2">
                  ...
                  <div className="p-4">
                    ...
                    <h3 onClick={() => navigate(getProductUrl(product))} className="text-xs sm:text-sm font-semibold text-black mb-2 group-hover:text-gold transition-colors duration-300 cursor-pointer">{product.name}</h3>
