        ...
        {products.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {products.map((product) => (
              <div key={product.id} className="group bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
                ...
                <div className="p-3 sm:p-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {product.originalPrice && (
                      <span className="text-gray-400 line-through text-sm">{currencyService.formatPrice(product.originalPrice)}</span>
                    )}
                  </div>
                </div>
              </div>
