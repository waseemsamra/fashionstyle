              ...
              {allProducts.map((product) => (
                <div key={product.id} className="group bg-white rounded-lg overflow-hidden shadow hover:shadow-lg transition">
                  ...
                  <div className="p-3 sm:p-4">
                    ...
                    <h3 onClick={() => navigate(getProductUrl(product))} className="font-semibold text-xs sm:text-sm lg:text-base mb-1 sm:mb-2 cursor-pointer hover:text-gold transition line-clamp-1 sm:line-clamp-2">{product.name}</h3>
