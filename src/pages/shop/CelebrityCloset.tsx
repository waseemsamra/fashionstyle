...
export default function CelebrityClosetShop() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        console.error('Failed to load celebrity closet:', error);
        if (isMounted) {
          setProducts([]);
        }
      }
  ...
  const celebrityProducts = useMemo(() => {
    return products.filter((p: any) => p.isCelebrityCloset);
  }, [products]);
      ...
      <div className="min-h-screen bg-beige-100 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center py-12">
            <h1 className="text-4xl font-bold mb-2">Celebrity Closet</h1>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Discover our celebrity closet picks - {celebrityProducts.length} products
          </p>
        </div>
