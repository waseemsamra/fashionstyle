...
export const API_CONFIG = {
  ...
  productsApi: import.meta.env.VITE_PRODUCTS_API || 'https://wpswtrwvil.execute-api.us-east-1.amazonaws.com/prod/products',
  ...
  brandsApi: import.meta.env.VITE_BRANDS_API || 'https://rvtv0snm8k.execute-api.us-east-1.amazonaws.com/prod/brands',
