...
export default function WeddingTales() {
  ...
  useEffect(() => {
    const updateItemsPerView = () => {
      ...
      console.log('📱 Wedding Tales Window width changed:', width);
      
      if (width >= 1024) {
        newItemsPerView = 4;
        console.log('✅ Wedding Tales Desktop mode - Showing 4 cards');
      } else if (width >= 768) {
        newItemsPerView = 2;
        console.log('✅ Wedding Tales Tablet mode - Showing 2 cards');
      } else {
        newItemsPerView = 1;
        console.log('✅ Wedding Tales Mobile mode - Showing 1 card');
      }
      
      console.log(`📊 Wedding Tales Setting itemsPerView to: ${newItemsPerView}`);
  ...
  if (loading) {
    console.log('⏳ Loading wedding tales products...');
    return (
  ...
  return (
    <section className="py-12 bg-beige-100">
      ...
      <div className="fixed top-0 right-0 bg-black text-white px-2 py-1 text-xs z-50 rounded-bl">
        Wedding Tales: {itemsPerView === 4 ? 'Desktop (4 cards)' : itemsPerView === 2 ? 'Tablet (2 cards)' : 'Mobile (1 card)'} | 
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Elegant collections for your special day
          </p>
        </div>
