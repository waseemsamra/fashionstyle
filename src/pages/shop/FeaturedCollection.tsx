...
export default function FeaturedCollectionShop() {
      ...
      <div className="min-h-screen bg-beige-100 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center py-12">
            <h1 className="text-4xl font-bold mb-2">Featured Collection</h1>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Discover our featured selection - {featuredProducts.length} products
          </p>
        </div>
