...
export default function ReadyToShipShop() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        console.error('Failed to load ready to ship:', error);
        if (isMounted) {
          setProducts([]);
        }
      }
  ...
  const readyProducts = useMemo(() => {
    return products.filter((p: any) => p.isReadyToShip);
  }, [products]);
      ...
      <div className="min-h-screen bg-beige-100 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center py-12">
            <h1 className="text-4xl font-bold mb-2">Ready To Ship</h1>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Discover products ready to ship - {readyProducts.length} products
          </p>
        </div>
