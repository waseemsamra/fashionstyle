...
export default function SummerCollection() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        console.error('Failed to load summer collection products:', error);
        if (isMounted) {
          setProducts([]);
        }
      }
  ...
  const summerProducts = useMemo(() => {
    return products.filter((p: any) => p.isSummerCollection);
  }, [products]);
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Discover our summer essentials - {summerProducts.length} products
          </p>
        </div>
