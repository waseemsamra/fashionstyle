      ...
      <div className="container-custom">
        ...
        <div className="text-center mt-12">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-8 py-4 border border-black rounded-full hover:bg-black hover:text-white"
          >
            View All Products
          </button>
        </div>
...
function ProductCard({ product, onWishlist, isInWishlist, onNavigate, onAddToCart }: any) {
  return (
    <div className="group bg-white rounded-2xl overflow-hidden shadow-card hover:shadow-hover transition-all hover:-translate-y-2">
      ...
      <div className="p-4">
        <p className="text-gray-500 text-xs uppercase mb-1">{product.brand || product.category || ''}</p>
         <h3 onClick={onNavigate} className="text-xs sm:text-sm font-semibold text-black mb-2 group-hover:text-gold cursor-pointer">{product.name}</h3>
