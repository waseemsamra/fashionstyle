...
export default function DesignersSpotlightShop() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        console.error('Failed to load designers spotlight:', error);
        if (isMounted) {
          setProducts([]);
        }
      }
  ...
  const spotlightProducts = useMemo(() => {
    return products.filter((p: any) => p.isDesignersSpotlight);
  }, [products]);
      ...
      <div className="min-h-screen bg-beige-100 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center py-12">
            <h1 className="text-4xl font-bold mb-2">Designers Spotlight</h1>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Discover designer spotlight picks - {spotlightProducts.length} products
          </p>
        </div>
