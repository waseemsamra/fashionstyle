    ...
    <section className="section-padding bg-white">
      <div className="container-custom">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <span className="text-gold text-sm font-medium tracking-wider uppercase block mb-1">Summer Essentials</span>
            <h2 className="font-playfair text-3xl md:text-4xl font-semibold text-black">Summer Collection</h2>
          </div>
          <button
            onClick={() => navigate('/summer-collection')}
        ...
        {isLoading ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">Loading summer collection...</p>
          </div>
        ) : products.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-gray-600">
              No summer collection products found yet. Please add products in Admin → Summer Collection.
            </p>
          </div>
        ) : (
          <>
