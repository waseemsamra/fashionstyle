...
export default function HandPickedShop() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        console.error('Failed to load hand picked:', error);
        if (isMounted) {
          setProducts([]);
        }
      }
  ...
  const handpickedProducts = useMemo(() => {
    return products.filter((p: any) => p.isHandPicked);
  }, [products]);
      ...
      <div className="min-h-screen bg-beige-100 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center py-12">
            <h1 className="text-4xl font-bold mb-2">Hand Picked</h1>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Discover our hand picked selection - {handpickedProducts.length} products
          </p>
        </div>
